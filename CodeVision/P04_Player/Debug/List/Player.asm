...
; 0000 009C             f_read(&archivo, bufferL, 44,&br); //leer encabezado
	...
	LDI  R31,HIGH(44)
	CALL SUBOPT_0xE
; 0000 009D             muestras=(long)bufferL[43]*16777216+(long)bufferL[42]*65536+(long)bufferL[41]*256+bufferL[40];  //obtener n� ...
...
; 0000 00E6     CLKPR=0x80;
	LDI  R30,LOW(128)
	STS  97,R30
; 0000 00E7     CLKPR=0x00;  //Micro físico a correr a 16MHz
	LDI  R30,LOW(0)
	STS  97,R30
; 0000 00E8 
; 0000 00E9     SetupLCD();
...
; 0000 00F0     PORTC.2=1;   //Forward
	SBI  0x8,2
; 0000 00F1 
; 0000 00F2     //Interrupción cada 10ms para SD (oscilador de 16MHz)
...
; 0000 00FE     TCCR2B=0x02;   // CK/8
	STS  177,R30
; 0000 00FF     OCR2A=90;      //Interrupción periódica cada 1/22050 seg (perido de muestreo)
	LDI  R30,LOW(90)
	STS  179,R30
; 0000 0100 

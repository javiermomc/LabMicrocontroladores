...
; 0000 0086                 if(bufferL[25] == 0x7D){
	...
	CPI  R26,LOW(0x7D)
	BRNE _0x3F
; 0000 0087                     OCR2A=62;    //Interrupción periódica cada 1/32000 seg     $7D00   lugar 25 leer 2 bytes mas signifi ...
	LDI  R30,LOW(62)
	RJMP _0x83
...
_0x3F:
	...
	CPI  R26,LOW(0x5D)
	BRNE _0x41
; 0000 0089                     OCR2A=82;    //Interrupción periódica cada 1/24000 seg     $5DC0
	LDI  R30,LOW(82)
	RJMP _0x83
...
_0x41:
	...
	CPI  R26,LOW(0x56)
	BRNE _0x43
; 0000 008B                     OCR2A=90;      //Interrupción periódica cada 1/22050 seg     $5622
	LDI  R30,LOW(90)
_0x83:
	STS  179,R30
; 0000 008C                 }
...
; 0000 00AF                      }
_0x5C:
; 0000 00B0                      if (PINC.3==0)     //botón de Foward
	SBIC 0x6,3
	RJMP _0x5F
; 0000 00B1                          br=0;
	LDI  R30,LOW(0)
...
; 0000 00D8         CLKPR=0x80;
	LDI  R30,LOW(128)
	STS  97,R30
; 0000 00D9         CLKPR=0x00;  //Micro físico a correr a 16MHz
	LDI  R30,LOW(0)
	STS  97,R30
; 0000 00DA 
; 0000 00DB         DDRD.0=1;
...
; 0000 00ED         TCCR2B=0x02;   // CK/8
	STS  177,R30
; 0000 00EE         OCR2A=90;      //Interrupción periódica cada 1/22050 seg
	LDI  R30,LOW(90)
	STS  179,R30
; 0000 00EF 

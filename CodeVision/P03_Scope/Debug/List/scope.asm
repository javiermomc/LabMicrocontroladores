...
;char aNum[9];
;void getNum(int num){
; 0000 0085 void getNum(int num){
_getNum:
; .FSTART _getNum
; 0000 0086     char i;
; 0000 0087     switch(num){
	ST   -Y,R27
	ST   -Y,R26
	ST   -Y,R17
;	num -> Y+1
...
; 0000 0088         case 0:
	SBIW R30,0
	BRNE _0x32
; 0000 0089             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x34:
	CPI  R17,9
	BRSH _0x35
; 0000 008A             aNum[i] = Letra0[i];
	CALL SUBOPT_0x9
	CALL SUBOPT_0xA
	SUBI R17,-1
	RJMP _0x34
...
_0x32:
	...
	CPC  R31,R26
	BRNE _0x36
; 0000 008D             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x38:
	CPI  R17,9
	BRSH _0x39
; 0000 008E             aNum[i] = Letra1[i];
	CALL SUBOPT_0x9
...
_0x36:
	...
	CPC  R31,R26
	BRNE _0x3A
; 0000 0091             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x3C:
	CPI  R17,9
	BRSH _0x3D
; 0000 0092             aNum[i] = Letra2[i];
	CALL SUBOPT_0x9
...
_0x3A:
	...
	CPC  R31,R26
	BRNE _0x3E
; 0000 0095             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x40:
	CPI  R17,9
	BRSH _0x41
; 0000 0096             aNum[i] = Letra3[i];
	CALL SUBOPT_0x9
...
_0x3E:
	...
	CPC  R31,R26
	BRNE _0x42
; 0000 0099             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x44:
	CPI  R17,9
	BRSH _0x45
; 0000 009A             aNum[i] = Letra4[i];
	CALL SUBOPT_0x9
...
_0x42:
	...
	CPC  R31,R26
	BRNE _0x46
; 0000 009D             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x48:
	CPI  R17,9
	BRSH _0x49
; 0000 009E             aNum[i] = Letra5[i];
	CALL SUBOPT_0x9
...
_0x46:
	...
	CPC  R31,R26
	BRNE _0x4A
; 0000 00A1             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x4C:
	CPI  R17,9
	BRSH _0x4D
; 0000 00A2             aNum[i] = Letra6[i];
	CALL SUBOPT_0x9
...
_0x4A:
	...
	CPC  R31,R26
	BRNE _0x4E
; 0000 00A5             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x50:
	CPI  R17,9
	BRSH _0x51
; 0000 00A6             aNum[i] = Letra7[i];
	CALL SUBOPT_0x9
...
_0x4E:
	...
	CPC  R31,R26
	BRNE _0x52
; 0000 00A9             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x54:
	CPI  R17,9
	BRSH _0x55
; 0000 00AA             aNum[i] = Letra8[i];
	CALL SUBOPT_0x9
...
_0x52:
	...
	CPC  R31,R26
	BRNE _0x56
; 0000 00AD             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x58:
	CPI  R17,9
	BRSH _0x59
; 0000 00AE             aNum[i] = Letra9[i];
	CALL SUBOPT_0x9
...
_0x56:
	...
	CPC  R31,R26
	BRNE _0x5A
; 0000 00B1             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x5C:
	CPI  R17,9
	BRSH _0x5D
; 0000 00B2             aNum[i] = LetraH[i];
	CALL SUBOPT_0x9
...
_0x5A:
	...
	CPC  R31,R26
	BRNE _0x62
; 0000 00B5             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x60:
	CPI  R17,9
	BRSH _0x61
; 0000 00B6             aNum[i] = LetraZ[i];
	CALL SUBOPT_0x9
...
; 0000 00B8         default:
_0x62:
; 0000 00B9             for(i=0;i<9;i++)
	LDI  R17,LOW(0)
_0x64:
	CPI  R17,9
	BRSH _0x65
; 0000 00BA             aNum[i] = Letra0[i];
	CALL SUBOPT_0x9
	CALL SUBOPT_0xA
	SUBI R17,-1
	RJMP _0x64
...
; 0000 00CC     // ADC Clock frequency: 1000.000 kHz
; 0000 00CD     // ADC Voltage Reference: Int., cap. on AREF
; 0000 00CE     // ADC High Speed Mode: On
; 0000 00CF     // Digital input buffers on ADC0: On, ADC1: On, ADC2: On, ADC3: On
; 0000 00D0     // ADC4: On, ADC5: On, ADC6: On, ADC7: Off
; 0000 00D1     CLKPR = 0x80;
	CALL SUBOPT_0xB
; 0000 00D2     CLKPR = 0;
; 0000 00D3     DIDR0=(1<<ADC7D) | (0<<ADC6D) | (0<<ADC5D) | (0<<ADC4D) | (0<<ADC3D) | (0<<ADC2D) | (0<<ADC1D) | (0<<ADC0D);
	LDI  R30,LOW(128)
	STS  126,R30
; 0000 00D4     ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(192)
	STS  124,R30
; 0000 00D5     ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(132)
	STS  122,R30
; 0000 00D6     ADCSRB=(1<<ADHSM);
	LDI  R30,LOW(128)
	STS  123,R30
; 0000 00D7 
; 0000 00D8     // Trigger for scope shot
; 0000 00D9     PORTD.7 = 1;
	SBI  0xB,7
; 0000 00DA 
; 0000 00DB     // SD
; 0000 00DC     CLKPR=0x80;
	CALL SUBOPT_0xB
; 0000 00DD     CLKPR=0;        //16 MHz
; 0000 00DE 
; 0000 00DF     // Código para hacer una interrupción periódica cada 10ms
; 0000 00E0 
; 0000 00E1     TCCR1B=0x0A;             //  CK/8
	LDI  R30,LOW(10)
	STS  129,R30
; 0000 00E2     OCR1AH=19999/256;
	LDI  R30,LOW(78)
	STS  137,R30
; 0000 00E3     OCR1AL=19999%256;
	LDI  R30,LOW(31)
	STS  136,R30
; 0000 00E4     TIMSK1=0x02;
	LDI  R30,LOW(2)
	STS  111,R30
; 0000 00E5     StringLCD("...");
	__POINTD2FN _0x0,33
...
; 0000 00EA     while (1) {
_0x68:
; 0000 00EB     // Please write your application code here
; 0000 00EC     MoveCursor(0,0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _MoveCursor
; 0000 00ED     StringLCD("Welcome");
	__POINTD2FN _0x0,37
	RCALL _StringLCD
; 0000 00EE         if (PIND.7 == 0){
	SBIC 0x9,7
	RJMP _0x6B
; 0000 00EF             EraseLCD();
	RCALL _EraseLCD
; 0000 00F0             StringLCD("Starting     ");
	__POINTD2FN _0x0,45
	RCALL _StringLCD
; 0000 00F1             scope();
	RCALL _scope
; 0000 00F2             freq = frequency();
	RCALL _frequency
	__PUTW1R 5,6
; 0000 00F3             sd_openDrive();
	RCALL _sd_openDrive
; 0000 00F4             if(f_open(&archivo,"0:BASE.BMP", FA_OPEN_EXISTING | FA_READ)==FR_OK){
	CALL SUBOPT_0xC
	__POINTW1MN _0x6D,0
	ST   -Y,R31
	ST   -Y,R30
	...
	BREQ PC+2
	RJMP _0x6C
; 0000 00F5                 f_read(&archivo, encabezado, 64, &br);
	CALL SUBOPT_0xC
	LDI  R30,LOW(_encabezado)
	LDI  R31,HIGH(_encabezado)
	CALL SUBOPT_0xD
	CALL _f_read
; 0000 00F6                 f_close(&archivo);
	LDI  R26,LOW(_archivo)
	LDI  R27,HIGH(_archivo)
	CALL _f_close
; 0000 00F7                 if (f_open(&archivo,fileName, FA_CREATE_ALWAYS | FA_WRITE)==FR_OK){
	CALL SUBOPT_0xC
	...
	BREQ PC+2
	RJMP _0x6E
; 0000 00F8                     f_write(&archivo,encabezado,sizeof(encabezado),&br);     //Escribir encabezado
	CALL SUBOPT_0xC
	LDI  R30,LOW(_encabezado)
	LDI  R31,HIGH(_encabezado)
	ST   -Y,R31
...
_0x70:
	...
	BRLT PC+2
	RJMP _0x71
; 0000 00FA                         for(j=0; j<64; j++){
	CLR  R3
_0x73:
	LDI  R30,LOW(64)
	CP   R3,R30
	BRSH _0x74
; 0000 00FB                             output[j] = 0xFF;
	MOV  R30,R3
	LDI  R31,0
...
_0x76:
	...
	BRLO PC+2
	RJMP _0x77
; 0000 00FE                             if(buffer[j]*256/1024==i){
	MOV  R30,R3
	CALL SUBOPT_0x6
	CALL __GETW1P
	MOV  R31,R30
...
; 0000 0107                                 getNum(d);
	MOV  R26,R12
	CALL SUBOPT_0xF
; 0000 0108                                 output[1]=aNum[18-i];
	__PUTB1MN _output,1
; 0000 0109                                 getNum(c);
	MOV  R26,R11
	CALL SUBOPT_0xF
; 0000 010A                                 output[2]=aNum[18-i];
	__PUTB1MN _output,2
; 0000 010B                                 getNum(u);
	MOV  R26,R14
	CALL SUBOPT_0xF
; 0000 010C                                 output[3]=aNum[18-i];
	__PUTB1MN _output,3
; 0000 010D                                 getNum(10);
	LDI  R26,LOW(10)
	CALL SUBOPT_0x10
; 0000 010E                                 output[4]=aNum[18-i];
	__PUTB1MN _output,4
; 0000 010F                                 getNum(11);
	LDI  R26,LOW(11)
	CALL SUBOPT_0x10
; 0000 0110                                 output[5]=aNum[18-i];
	__PUTB1MN _output,5
; 0000 0111                             }
; 0000 0112                         }
_0x7B:
	...
	RJMP _0x76
_0x77:
; 0000 0113                         f_write(&archivo,output,sizeof(output),&br);
	CALL SUBOPT_0xC
	LDI  R30,LOW(_output)
...
; 0000 0115                     EraseLCD();
	RCALL _EraseLCD
; 0000 0116                     StringLCD("Listo      ");
	__POINTD2FN _0x0,70
	RCALL _StringLCD
; 0000 0117                     f_close(&archivo);
	LDI  R26,LOW(_archivo)
	LDI  R27,HIGH(_archivo)
	CALL _f_close
...
; 0000 011A                     EraseLCD();
	CALL SUBOPT_0x7
; 0000 011B                     MoveCursor(0,0);
; 0000 011C                     StringLCD("File error");
	__POINTD2FN _0x0,82
	CALL _StringLCD
...
; 0000 0120                EraseLCD();
	CALL SUBOPT_0x7
; 0000 0121                MoveCursor(0,0);
; 0000 0122                StringLCD("base.bmp error");
	__POINTD2FN _0x0,93
	CALL SUBOPT_0x8
; 0000 0123                delay_ms(1000);
; 0000 0124             }
_0x7D:
; 0000 0125             sd_closeDrive();

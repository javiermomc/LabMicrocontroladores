...
_0x0:
	.DB  0x25,0x63,0x2F,0x6E,0x2F,0x72,0x0
__RESET:
	CLI
	CLR  R30
	OUT  EECR,R30
...
; 0000 0026 // USART1 Transmitter: Off
...
; 0000 0029 UCSR1A=(0<<RXC1) | (0<<TXC1) | (0<<UDRE1) | (0<<FE1) | (0<<DOR1) | (0<<UPE1) | (0<<U2X1) | (0<<MPCM1);
	LDI  R30,LOW(0)
	STS  200,R30
; 0000 002A UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (1<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	LDI  R30,LOW(16)
	STS  201,R30
